...
h = pm.nextPlot('zpos_visc0p5_act-normalised','Visualisation of  precomputed trajectories',...
            ...
            'activation in 41ms','activation in 49ms','activation in 58ms',...
            'activation in 69ms','activation in 83ms','activation in 100ms','Location','SouthEast'});
sel = 1:10:100;% start with: visc 0.5 - 1, visc 5.1 - 8; visc 10 - 10
...
%
h = pm.nextPlot('mesh_zpos',sprintf('z-position of middle node at t=%g',t(end)),...
...
for ts = 1:length(t)
    ...
    cla(h);
    %
    surfc(h,paramspace_act,paramspace_visc,mesh_oz,'FaceColor','interp','EdgeColor','interp');
